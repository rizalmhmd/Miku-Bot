...
async function instagramdl(url) {
    ...
    if (!/https?:\/\/www\.instagram\.com\/(reel|tv|p)\//i.test(url)) {
        throw new utils_1.ScraperError('Invalid url!!');
    }
    ...
    if (!Array.isArray(params) || params.length !== 6)
        throw new utils_1.ScraperError(`Can't parse decode parameters!\n${data}`);
...
async function instagramStory(name) {
    const resKey = await (0, got_1.default)('https://storydownloader.net/en');
    ...
    const res = await (0, got_1.default)('https://storydownloader.net/request', {
        method: 'POST',
        headers: {
            ...headers,
            ...formData.getHeaders()
