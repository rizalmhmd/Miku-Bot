...
async function tiktokdl(url) {
    ...
    if (!Array.isArray(decodeParams) || decodeParams.length !== 6)
        throw new utils_1.ScraperError(`failed to parse decode params!\n${html}`);
    const decode = (0, utils_1.decodeSnapApp)(...decodeParams);
    ...
    if (!result)
        throw new utils_1.ScraperError(`failed to parse html from decode!\n${decode}`);
